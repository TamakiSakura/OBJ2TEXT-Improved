...
class CocoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img_id, image, captions, labels, locations, visuals
...
def collate_fn(data):
    ...
    img_id, images, captions, label_seqs, location_seqs, visual_seqs = zip(*data)
    ...
    return img_id, images, captions, label_seq_data, location_seq_data, visual_seq_data, label_seq_lengths
